...
const selectors = {
  ...
  configuratorOptions: '.js.c-product__configurator__option__input-wrapper',
};
...
register('product', {
  async onLoad() {
    ...
    // Update variant image on configurator option change
    const configuratorOptions = document.querySelectorAll(selectors.configuratorOptions);
    console.log('DEBUG configuratorOption', configuratorOptions);

    configuratorOptions.forEach(element => {
      element.addEventListener('change', e => {
        console.log('DEBUG configuratorOption changed, ', e);
  ...
  onFormOptionChange(event) {
    console.log('DEBUG onformOptionChange');
